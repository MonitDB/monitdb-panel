...
;(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === 'object') exports['QP'] = factory()
  else root['QP'] = factory()
})(window, function () {
    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function getNodeXml(queryPlanXml, statementId, nodeId) {
          var statement = queryPlanXml.querySelector(
          ...
          for (var i = 0; i < elements.length; i++) {
            ...
            if (
              element.attributes['NodeId'] &&
              element.attributes['NodeId'].value == nodeId
            ) {
              return element
            }
          }
        ...
        var RelOp = /** @class */ (function () {
          ...
          Object.defineProperty(RelOp.prototype, 'runtimeCountersPerThread', {
            ...
            get: function () {
              ...
              return find(
                runtimeInformation[0].childNodes,
          ...
          Object.defineProperty(RelOp.prototype, 'actualRows', {
             ...
             */
            get: function () {
              return this.runtimeCountersPerThread.length == 0
                ? null
                : this.runtimeCountersPerThread.reduce(function (a, b) {
                    return a + parseFloat(b.attributes['ActualRows'].value)
                  }, 0)
            },
            enumerable: true,
            configurable: true,
          ...
          Object.defineProperty(RelOp.prototype, 'actualRowsRead', {
            ...
            get: function () {
              return this.runtimeCountersPerThread.length == 0 ||
                !this.runtimeCountersPerThread[0].attributes['ActualRowsRead']
                ? null
                : this.runtimeCountersPerThread.reduce(function (a, b) {
                    return a + parseFloat(b.attributes['ActualRowsRead'].value)
                  }, 0)
            },
            enumerable: true,
            configurable: true,
        ...
        var Node = /** @class */ (function () {
          ...
          Object.defineProperty(Node.prototype, 'children', {
            ...
            get: function () {
              return [].slice
                .call(
                  utils_1.findAncestor(this.element, 'qp-tr').children[1]
                    .children
                )
                .map(function (c) {
                  return new Node(c.children[0].children[0].children[0])
                })
            },
            enumerable: true,
            configurable: true,
          ...
          Object.defineProperty(Node.prototype, 'statementId', {
             ...
             */
            get: function () {
              var statement = utils_1.findAncestorP(this.element, function (e) {
                return e.hasAttribute('data-statement-id')
              })
          ...
          Object.defineProperty(Node.prototype, 'relOp', {
            ...
            get: function () {
              ...
              return nodeXml && nodeXml.tagName == 'RelOp'
                ? new RelOp(this.nodeXml)
                : null
            },
            enumerable: true,
            configurable: true,
        ...
        var Line = /** @class */ (function () {
          ...
          Object.defineProperty(Line.prototype, 'queryPlanXml', {
             ...
             */
            get: function () {
              return utils_1.findAncestor(this.element, 'qp-root')
                .parentElement['xml']
            },
            enumerable: true,
            configurable: true,
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function findAncestor(element, className) {
          return findAncestorP(element, function (e) {
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function showPlan(container, planXml, options) {
          ...
          container['xml'] = new DOMParser().parseFromString(
            planXml,
            'text/xml'
          )
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function thicknessesToOffsets(thicknesses, gap) {
          var result = []
          var total =
            thicknesses.reduce(function (a, b) {
              return a + b
            }, 0) +
            (thicknesses.length - 1) * gap
          var left = -total / 2
        ...
        function nodeToThickness(node) {
          ...
          if (node.relOp != null) {
            rows =
              node.relOp.actualRows == null
                ? node.relOp.estimatedRows
                : node.relOp.actualRows
          }
          return Math.max(
            minThickness,
            Math.min(Math.floor(Math.log(rows > 0 ? rows : 1)), maxThickness)
          )
        }
        ...
        function drawLinesForParent(draw, clientRect, parent) {
          ...
          var padding =
            ...
            lineSeparation * (children.length - 1)
         ...
         */
        function drawArrowBetweenNodes(
          draw,
          clientRect,
          parent,
          child,
          ...
          function (window, document) {
            ...
            SVG.Color = function (color) {
              ...
              if (typeof color === 'string') {
                if (SVG.regex.isRgb.test(color)) {
                  // get rgb values
                  match = SVG.regex.rgb.exec(
                    color.replace(SVG.regex.whitespace, '')
                  )
            ...
            SVG.extend(SVG.Array, {
              ...
              at: function (pos) {
                ...
                for (var i = 0, il = this.value.length, array = []; i < il; i++)
                  array.push(
                    this.value[i] + (this.destination[i] - this.value[i]) * pos
                  )
            ...
            SVG.extend(SVG.PointArray, {
              ...
              at: function (pos) {
                ...
                for (var i = 0, il = this.value.length, array = []; i < il; i++)
                  array.push([
                    this.value[i][0] +
                      (this.destination[i][0] - this.value[i][0]) * pos,
                    this.value[i][1] +
                      (this.destination[i][1] - this.value[i][1]) * pos,
                  ])
                ...
                for (i = this.value.length - 1; i >= 0; i--) {
                  ...
                  if (l == 'M' || l == 'L' || l == 'T') {
                    ...
                    if (l == 'C') {
                      ...
                      this.value[i][6] =
                        ((this.value[i][6] - box.y) * height) / box.height +
                        box.y
                    }
                  } else if (l == 'A') {
                    // resize radii
                  ...
                  arr.push(
                    pathHandlers[s].call(
                      ...
                      array
                        .slice(
                          index,
                          (index = index + paramCnt[s.toUpperCase()])
                        )
                        .map(parseFloat),
                      p,
                      p0
            ...
            SVG.Element = SVG.invent({
              ...
              extend: {
                ...
                classes: function () {
                  ...
                  return attr == null
                    ? []
                    : attr.trim().split(SVG.regex.delimiter)
                },
                ...
                svg: function (svg) {
                  ...
                  if (svg && this instanceof SVG.Parent) {
                    ...
                    // transplant nodes
                    for (
                      var i = 0, il = well.firstChild.childNodes.length;
                      i < il;
                      i++
                    )
            ...
            SVG.Box = SVG.invent({
              ...
              extend: {
                ...
                merge: function (box) {
                  ...
                  b.width =
                    Math.max(this.x + this.width, box.x + box.width) - b.x
                  b.height =
                    Math.max(this.y + this.height, box.y + box.height) - b.y
            ...
            SVG.RBox = SVG.invent({
              ...
              construct: {
                ...
                rbox: function (el) {
                  if (el)
                    return new SVG.RBox(this).transform(
                      el.screenCTM().inverse()
                    )
              ...
              extend: {
                ...
                around: function (cx, cy, matrix) {
                  return this.multiply(
                    new SVG.Matrix(1, 0, 0, 1, cx || 0, cy || 0)
                  )
                    .multiply(matrix)
         ...
         However all other Browsers do that */
              ...
              extend: {
                ...
                transform: function (matrix) {
                  return new SVG.Point(
                    this.native().matrixTransform(matrix.native())
                  )
                },
              },
            })
              ...
              transform: function (o, relative) {
                ...
                if (o.a != null) {
                  ...
                  matrix = relative
                    ...
                    : // absolute
                      matrix.rotate(
                        o.rotation - matrix.extract().rotation,
                        o.cx,
                        o.cy
                      )
                  ...
                  o.skewX =
                    o.skew != null ? o.skew : o.skewX != null ? o.skewX : 0
                  o.skewY =
                    o.skew != null ? o.skew : o.skewY != null ? o.skewY : 0
                  ...
                  if (!relative) {
                    ...
                    matrix = matrix.multiply(
                      new SVG.Matrix()
                        .skew(e.skewX, e.skewY, o.cx, o.cy)
                        .inverse()
                    )
                  }
            ...
            SVG.extend(SVG.Parent, {
              ungroup: function (parent, depth) {
                ...
                parent =
                  parent ||
                  (this instanceof SVG.Doc ? this : this.parent(SVG.Parent))
            ...
            SVG.ViewBox = SVG.invent({
              ...
              construct: {
                ...
                viewbox: function (x, y, width, height) {
                  ...
                  return this.attr(
                    'viewBox',
                    new SVG.ViewBox(x, y, width, height)
                  )
                },
              },
            })
            ...
            SVG.on = function (node, event, listener, binding, options) {
              ...
              var l = listener.bind(binding || node.instance || node),
                index =
                  (SVG.handlerMap.indexOf(node) + 1 ||
                    SVG.handlerMap.push(node)) - 1,
                ev = event.split('.')[0],
                ns = event.split('.')[1] || '*'
            ...
            SVG.off = function (node, event, listener) {
              ...
              if (listener) {
                ...
                if (
                  SVG.listeners[index][ev] &&
                  SVG.listeners[index][ev][ns || '*']
                ) {
                  // remove listener
                  node.removeEventListener(
                    ev,
                    SVG.listeners[index][ev][ns || '*'][listener],
                    false
                  )
            ...
            SVG.G = SVG.invent({
              ...
              extend: {
                ...
                cx: function (x) {
                  return x == null
                    ? this.gbox().cx
                    : this.x(x - this.gbox().width / 2)
                },
                // Move by center over y-axis
                cy: function (y) {
                  return y == null
                    ? this.gbox().cy
                    : this.y(y - this.gbox().height / 2)
                },
                gbox: function () {
                  var bbox = this.bbox(),
            ...
            SVG.Line = SVG.invent({
              ...
              extend: {
                ...
                size: function (width, height) {
                  ...
                  return this.attr(
                    this.array().size(p.width, p.height).toLine()
                  )
                },
              },
            ...
            SVG.Polyline = SVG.invent({
              ...
              construct: {
                ...
                polyline: function (p) {
                  // make sure plot is called as a setter
                  return this.put(new SVG.Polyline()).plot(
                    p || new SVG.PointArray()
                  )
                },
              },
            })
            ...
            SVG.Polygon = SVG.invent({
              ...
              construct: {
                ...
                polygon: function (p) {
                  // make sure plot is called as a setter
                  return this.put(new SVG.Polygon()).plot(
                    p || new SVG.PointArray()
                  )
                },
              },
            ...
            SVG.extend(SVG.Polyline, SVG.Polygon, {
              ...
              array: function () {
                return (
                  this._array ||
                  (this._array = new SVG.PointArray(this.attr('points')))
                )
              },
              // Plot new path
              plot: function (p) {
            ...
            SVG.Path = SVG.invent({
              ...
              extend: {
                ...
                array: function () {
                  return (
                    this._array ||
                    (this._array = new SVG.PathArray(this.attr('d')))
                  )
                },
                // Plot new path
                plot: function (d) {
                  return d == null
                    ...
                    : this.clear().attr(
                        ...
                        typeof d == 'string'
                          ? d
                          : (this._array = new SVG.PathArray(d))
                      )
                },
                // Clear array cache
                clear: function () {
            ...
            SVG.Text = SVG.invent({
              ...
              extend: {
                ...
                cx: function (x) {
                  return x == null
                    ? this.bbox().cx
                    : this.x(x - this.bbox().width / 2)
                },
                // Move center over y-axis
                cy: function (y) {
                  return y == null
                    ? this.bbox().cy
                    : this.y(y - this.bbox().height / 2)
                },
                ...
                rebuild: function (rebuild) {
                  ...
                  if (this._rebuild) {
                    var self = this,
                      ...
                      dy =
                        this.dom.leading *
                        new SVG.Number(this.attr('font-size'))
            ...
            SVG.Tspan = SVG.invent({
              ...
              extend: {
                ...
                newLine: function () {
                  ...
                  // apply new hy¡n
                  return this.dy(t.dom.leading * t.attr('font-size')).attr(
                    'x',
                    t.x()
                  )
                },
              ...
              methods.forEach(function (method) {
                SVG.Set.prototype[method] = function () {
                  for (var i = 0, il = this.members.length; i < il; i++)
                    if (
                      this.members[i] &&
                      typeof this.members[i][method] == 'function'
                    )
            ...
            SVG.select = function (query, parent) {
              return new SVG.Set(
                SVG.utils.map(
                  (parent || document).querySelectorAll(query),
                  function (node) {
                    return SVG.adopt(node)
                  }
                )
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function initTooltip(container) {
          ...
          for (var i = 0; i < nodes.length; i++) {
            addTooltip(nodes[i], function (e) {
              return e.querySelector('.qp-tt').cloneNode(true)
            })
          }
        ...
        function addTooltip(node, createTooltip) {
          node.addEventListener('mouseover', function () {
            return onMouseover(node, createTooltip)
          })
          node.addEventListener('mouseout', function (event) {
            return onMouseout(node, event)
          })
        }
        ...
        function onMouseout(node, event) {
          ...
          if (
            utils_1.findAncestorP(e, function (x) {
              return x == node
            })
          )
            return
        ...
        function buildLineTooltip(line) {
          ...
          var parser = new DOMParser()
          var actualNumberOfRows =
            line.relOp.actualRows != null
              ? '<tr>\n            <th>Actual Number of Rows</th>\n            <td>' +
                line.relOp.actualRows +
                '</td>\n        </tr>'
              : ''
          var numberOfRowsRead =
            line.relOp.actualRowsRead != null
              ? '<tr>\n            <th>Number of Rows Read</th>\n            <td>' +
                line.relOp.actualRowsRead +
                '</td>\n        </tr>'
              : ''
          var document = parser.parseFromString(
            '\n        <div class="qp-tt"><table><tbody>\n        ' +
              ...
              line.relOp.estimatedRows +
              '</td>\n        </tr>\n        <tr>\n            <th>Estimated Row Size</th>\n            <td>' +
              convertSize(line.relOp.estimatedRowSize) +
              '</td>\n        </tr>\n        <tr>\n            <th>Estimated Data Size</th>\n            <td>' +
              convertSize(line.relOp.estimatedDataSize) +
              '</td>\n        </tr>\n        </tbody></tabke></div>\n    ',
            'text/html'
          )
