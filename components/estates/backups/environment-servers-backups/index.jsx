  ...
  return (
    <div className="p-3 pb-0 space-y-3">
      {servers.map(({ id, serverName }, index) => {
        ...
        const fullBackup = separetedBackups.Full ? separetedBackups.Full[0] : {}
        const diferentialBackup = separetedBackups.Diferencial
          ? separetedBackups.Diferencial[0]
          : {}
        const logBackup = separetedBackups.Log ? separetedBackups.Log[0] : {}
        ...
        const DATA = {
          Full: {
            lastBackup: {
              ...
              intervalTime:
                fullBackup.backup_start_date && fullBackup.backup_finish_date
                  ? getIntervalTime(
            ...
            allBackups: separetedBackups.Full || [],
          },
          Diferential: {
            lastBackup: {
            ...
            allBackups: separetedBackups.Diferencial || [],
          },
          Log: {
            lastBackup: {
              ...
              intervalTime:
                logBackup.backup_start_date && logBackup.backup_finish_date
                  ? getIntervalTime(
            ...
            allBackups: separetedBackups.Log || [],
          },
        }
